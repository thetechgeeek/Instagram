...
const RegisterScreen = () => {
    ...
    return (
        <>
            <div className='container d-flex flex-row justify-content-center' style={{ marginTop: ' 40px', marginBottom: ' 40px' }}>
                <div style={{ marginTop: ' 30px' }}>
                    ...
                    >
                        ...
                        <div>
                            <p style={{ width: ' 258px', margin: ' auto' }}>Sign up to see photos and videos from your friends</p>
                        </div>
                        <button
                            className='btn'
                            type='button'
                        ...
                        >
                            <span>By signing up, you agree to our Terms, Data Policy and Cookie Policy</span>
                        </div>
                    </form>
                    <form
                        style={{
