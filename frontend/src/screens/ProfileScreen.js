...
const ProfileScreen = () => {
    ...
    return (
        <>
            ...
            {state ? (
                <>
                    <div className='container text-center flex-row flex-grow-1 justify-content-center' style={{ marginTop: '70px' }}>
                        <div className='row d-flex flex-column' style={{ maxWidth: '953px', margin: 'auto', marginTop: '15px' }}>
                            <div className='col'>
                                <div className='row'>
                                    <div className='col-4 d-flex flex-column justify-content-start align-items-center' style={{ paddingTop: '16px' }}>
                                        <img alt='' className='rounded-circle center-cropped' src={state.image} />
                                    </div>
                                    <div className='col-8 text-start' style={{ marginBottom: '20px' }}>
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                >
                                                    <Link style={{ textDecoration: 'none', color: 'black' }} to={'/editprofile'}>
                                                        Edit Profile
                                                    </Link>
                                                </button>
                                            </div>
                                        ...
                                        >
                                            <span style={{ marginRight: '10px' }}>{myPosts.length} posts</span>
                                            <span style={{ marginRight: '10px' }}>{state.followers.length} followers</span>
                                            <span>{state.following.length} following</span>
                                        </div>
                                        <div style={{ textAlign: 'left' }}>
                                            <h6 style={{ marginBottom: '2px' }}>{state ? state.name : 'Loading...'}</h6>
                                            <p>
                                                {state.bio}
                                                <br />
                                            </p>
                                    ...
                                    >
                                        ...
                                        >
                                            <div>
                                                <span className='d-inline-block'>{myPosts.length} posts</span>
                                            </div>
                                            <div>
                                                <span className='d-inline-block'>{state.followers.length} followers</span>
                                            </div>
                                            <div>
                                                <span className='d-inline-block'>{state.following.length} following</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                                ...
                                                                {myPosts ? (
                                                                    myPosts.map((post) => (
                                                                        <div className='col-sm-6 col-md-4 col-lg-3 item'>
                                                                            <a href='desk.jpg'>
                                                                                <img alt='' className='img-fluid' src={post.image} />
                                                                            </a>
                                                                        </div>
                                                                    ))
                                                                ) : (
