...
const CreatePostScreen = () => {
    ...
    return (
        <>
            ...
            >
                <h2 className='text-center' style={{ fontWeight: '200', marginTop: '15px', marginBottom: '50px' }}>
                    Create Post
                </h2>{' '}
                <Toast
                    style={{
                ...
                <div className='form-group row' style={{ marginBottom: '15px' }}>
                    ...
                    <div className='col-sm-10'>
                        <input type='file' className='shadow-none form-control' id='photo' onChange={(e) => setImage(e.target.files[0])} />
                    </div>
                </div>
                <div className='form-group row' style={{ marginBottom: '15px' }}>
                ...
                <button className='btn btn-primary shadow-none py-0 mx-auto' style={{ marginTop: '10px' }} onClick={() => postDetail()}>
                    Submit
                </button>
            </div>
            <Footer />
